...
--     end Generate;
   ...
   begin
      ...
      declare
         use GNATCOLL.VFS;
         use all type Alire.Features.Init.Kinds;
      ...
      begin
         ...
         Alire.Features.Init.Working_Release
           (Name          => +Name,
            Kind          => (if Cmd.Bin then Binary
                              elsif Cmd.Lib then Library
                              else raise Program_Error),
            Path          => +Directory.Full_Name,
            Metadata_Only => Cmd.No_Skel);
